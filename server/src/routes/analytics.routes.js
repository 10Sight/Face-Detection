...
import { getHistory, getQuickStats, forensicSearch, getReport, getTimeline } from "../controllers/analytics.controller.js";
...
router.route("/timeline/:faceId").get(getTimeline);
